...
services:
  ...
  openemr:
    ...
    environment:
      ...
      COPILOT_INTERNAL_ENDPOINTS_PUBLIC: "${COPILOT_INTERNAL_ENDPOINTS_PUBLIC:-0}"
      COPILOT_INTERNAL_ALLOW_CIDRS: "${COPILOT_INTERNAL_ALLOW_CIDRS:-}"
    depends_on:
      mysql:
  ...
  copilot-sidecar:
    ...
    environment:
      ...
      COPILOT_GATEWAY_DISCLOSURE_URL: "${COPILOT_GATEWAY_DISCLOSURE_URL:-http://openemr/interface/ask_copilot/disclosure.php}"
      ...
      COPILOT_READY_CACHE_TTL_SECONDS: "${COPILOT_READY_CACHE_TTL_SECONDS:-30}"
...
COPILOT_GATEWAY_DISCLOSURE_URL=http://openemr/interface/ask_copilot/disclosure.php
COPILOT_INTERNAL_ENDPOINTS_PUBLIC=0
COPILOT_INTERNAL_ALLOW_CIDRS=
COPILOT_READY_CACHE_TTL_SECONDS=30
OPENROUTER_API_KEY=
...
LANGSMITH_API_KEY=
LANGSMITH_PROJECT=openemr-copilot-demo
LANGSMITH_HIDE_INPUTS=true
LANGSMITH_HIDE_OUTPUTS=true
EOF
